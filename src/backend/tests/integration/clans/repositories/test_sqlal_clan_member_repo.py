...
async def test_save_inserts_new_clan_member(clan_member_repo):
...
async def test_save_updates_existing_clan_member(clan_member_repo):
    clan_member = ClanMember.create(73, uuid4())
...
async def test_get_clan_member_by_player_id(clan_member_repo):
    clan_member = ClanMember.create(73, uuid4())
...
async def test_get_clan_members_by_clan_id(clan_member_repo):
    clan_id = uuid4()
...
async def test_get_nonexistent_clan_member_returns_none(clan_member_repo):
