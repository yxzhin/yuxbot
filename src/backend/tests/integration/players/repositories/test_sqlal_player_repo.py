...
async def test_save_inserts_new_player(player_repo_factory):
    player_repo = player_repo_factory()
...
async def test_save_updates_existing_player(player_repo_factory):
    player_repo = player_repo_factory()
...
async def test_get_player_by_username(player_repo_factory):
    player_repo = player_repo_factory()
...
async def test_get_nonexistent_player_returns_none(player_repo_factory):
    player_repo = player_repo_factory()
